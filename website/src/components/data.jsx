export default function Data({ index, gpsData, gyroData, temperatureData }) {
	...
	return (
		<div className="text-white flex flex-row gap-10 p-8 justify-between text-2xl">
			<div className="w-96">
				<p>Höhe:&nbsp;&nbsp;{temperaturePoint?.altitude ?? "-"} m</p>
				<p>Geschwindigkeit:&nbsp;&nbsp;{gpsPoint?.kmh ?? "-"} km/h</p>
				<p>
					Beschleunigung:&nbsp;&nbsp;
					{Math.sqrt(
						gyroPoint?.aX ** 2 +
			...
			<div className="w-72">
				...
				<p>
					Luftdruck:&nbsp;&nbsp;{temperaturePoint?.pressure ?? "-"} Pa
				</p>
			</div>
			<div className="w-72">
